...
<head>
	...
	<title>Deleting | Student Records</title>
</head>
<body>
			...
			<?php
				...
				?>
					<div class = "container" style="padding-top: 10px;width: 50%;">
                        <p style="text-align:center; font-size:20px;color:red;"><i class="fa fa-times-circle" style="color: red; font-size:50px;"></i> <br><?php echo "USN: ".$USN." Not Found";?></p>
                    </div>
		    	<?php
				}
				else{
					...
					<div class = "container" style="background-color: #BDE87F;padding-top: 10px;width: 50%;">
                        <p style="text-align:center; font-size:20px;color: green;"><i class="fa fa-check-circle" style="color: green; font-size:50px;"></i> <br><?php echo "USN: ".$USN." Successfully Deleted";?></p>
                    </div>
		    		<?php
				}
				?>
