...
<head>
	...
	<title>About us | Student Records</title>
</head>
<body>
		...
		<div class="container">
			<div class="on-it w3-container w3-center w3-animate-top" style="background-image: linear-gradient(#248da3, #2c4b52);">
	    		<div class="about-first">
	    			...
	    			<small style="font-family: 'Uchen', serif;font-size: 12px; text-align:  center;position:absolute;left: 43%; bottom: 5px;">Credits- Monisha M, Harshitha K M<br>(1DT18IS056,1DT18IS035)</small>
		    	</div>
	    	</div>
		</div>
	</font>
