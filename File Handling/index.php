...
<body>
	<font class="fontstyle">
		...
		<div class="container">
						...
						<div style="background-image:linear-gradient(#248da3, #2c4b52);padding: 20px 35px 20px 35px; margin-top: 10%;" class="container">
							...
							<form action="./TeacherConnect.php" method="post">
								...
								<div class="form-floating">
									<input type="password" class="form-control" id="myInput" placeholder="Password" name="passwrd" required>
									<p></p>
			...
			<p></p>
			<small style="color: black;font-family: 'Uchen', serif;font-size: 12px; text-align:  center;position:absolute;left: 43%;">Credits- Monisha M, Harshitha K M<br>(1DT18IS056,1DT18IS035)</small>
		</div>
	</font>
