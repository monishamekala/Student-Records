...
<head>
	...
	<title>Info | Student Records</title>
</head>
<body>
			...
			<?php
				...
				?>
					<div class = "container w3-container w3-center w3-animate-zoom" style="margin-top: 5%;width: 50%;">
                    		<p style="font-size:10px; color:#126e82; text-align: center;"><i class="fa fa-address-card" style="color: #126e82; font-size:60px;"></i></p>
		    			</div>
