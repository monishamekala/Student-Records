...
<head>
	...
	<title>New Student | Student Records</title>
</head>
<body>
		...
		<div class="container">
			<div class="row justify-content-around">
			    <div class="w-50 p-3" style="background-image: linear-gradient(#248da3, #2c4b52);">
			    	<form action="./addcsv.php" method="post">
						...
						<div class="form-group row">
						    ...
						    <div class="col-sm-10">
						      ...
						      placeholder="Age of student" min="1998-01-01" max="2001-12-31" required>
						    </div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
						    <div class="col">
						    	<button type="submit" class="btn btn-outline-own1">Add</button>
						    </div>
						</div>
			    	</form>
			    </div>
