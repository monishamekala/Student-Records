...
<head>
	...
	<title>Updating | Student Records</title>
</head>
<body>
			...
			<?php
				...
				?>
					<div class = "container" style="padding-top: 10px;width: 50%;">
                        <p style="text-align:center; font-size:20px;color:red;"><i class="fa fa-times-circle" style="color: red; font-size:50px;"></i> <br><?php echo "USN: ".$USN." details not Found";?></p>
                    </div>
				<?php
				}
				else{ 
				...
				if($done == true){ ?>
					<div class = "container" style="background-color: #BDE87F;padding-top: 10px;width: 50%;">
                        <p style="text-align:center; font-size:20px;color: green;"><i class="fa fa-check-circle" style="color: green; font-size:50px;"></i> <br><?php echo $NAME."(".$USN.") details Successfully Updated."?></p>
                    </div>
				<?php 
				}
			?>
